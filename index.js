    ...
    switch (command) {
      ...
      case '.اوامر': {
        const helpText = `📋 *قائمة أوامر ايرن بوت*\n\n` +
          ...
          `🛡️ *أدمن*\n` +
          `.انطر .رفاعي .شدفيه .هنرش مياه .افتح يبني\n` +
          `.منع روابط .روابط ايقاف .منشن .حذف\n` +
          `.انذار .الانذارات .حذف_انذار .جروب_اسم .جروب_وصف\n\n` +
          `📹 *ميديا*\n` +
          `.شغل .تيكتوك .انستا .لصوت .لجيف .لصوره .نسخ\n\n` +
          `🔊 *أصوات*\n` +
          `.سمكة .بورعي .ايرن .موحشتكش (للأونر)\n\n` +
          `⚙️ *نظام*\n` +
          `.قائمة .تست .بنج .مسابقه .رفرش .بور_اوف\n\n` +
          `😂 *ترول*\n` +
          `.ترول\n\n` +
          `💬 *تفاعل*\n` +
          `.مزاجي\n\n` +
